...
autocmd BufWritePost * call RaiseWarningForFlake8Issues()
...
" Persistent undo
set undodir=/home/<your_user_name>/.vim/undodir
set undofile
...
set ttymouse=xterm2
set tags=~/mytags
vnoremap gb :<C-U>!git blame <C-R>=expand("%:p") <CR> \| sed -n <C-R>=line("'<") <CR>,<C-R>=line("'>") <CR>p <CR>
